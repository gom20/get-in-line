...
class APIPlaceControllerTest {
    ...
    void givenNothing_whenRequestingPlaces_thenReturnsListOfPlaces() throws Exception {
        ...
        mvc.perform(get("/api/places"))
                ...
                .andExpect(jsonPath("$.data[0].placeName").value("랄라탁구장"))
                .andExpect(jsonPath("$.data[0].address").value("경기도 이천시"))
                .andExpect(jsonPath("$.data[0].phoneNumber").value("123-1111-2222"))
    ...
    void givenPlaceAndItsId_whenRequestingPlace_thenReturnsPlaceInStandardResponse() throws Exception {
        ...
        mvc.perform(get("/api/places/"+placeId))
                ...
                .andExpect(jsonPath("$.data.placeName").value("랄라탁구장"))
                .andExpect(jsonPath("$.data.address").value("경기도 이천시"))
                .andExpect(jsonPath("$.data.phoneNumber").value("123-1111-2222"))
